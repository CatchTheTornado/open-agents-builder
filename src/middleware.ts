...
export const config = {
  matcher: '/((?!api/db|api/agent/.*/exec|api/chat|api/chat/upload|api/exec|api/og|storage|api/saas|api/agent/results-chat|content|img|_next/image|_next/static|static|.*\\..*|_next).*)',
